    ...
    <main class="admin-main">
        ...
        <div class="admin-main__sidebar">
            <ul class="admin-main__sidebar--ul">
                ...
                <a href="products.php">
                    <li><svg class="product-icon icon" xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24">
                ...
                <a href="orders.php" class="active">
                    <li class="small-active"><svg class="order-icon icon" xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24">
